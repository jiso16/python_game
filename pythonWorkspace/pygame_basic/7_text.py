...
#배경이미지 불러오기
background = pygame.image.load("C:\\Users\\jisohee\\Desktop\\pythonWorkspace\\pygame_basic\\background.png")

#캐릭터(스프라이트)불러오기
character = pygame.image.load("C:\\Users\\jisohee\\Desktop\\pythonWorkspace\\pygame_basic\\character.png")
...
#적 enemy 캐릭터
enemy = pygame.image.load("C:\\Users\\jisohee\\Desktop\\pythonWorkspace\\pygame_basic\\enemy.png")
...
while running:
    ...
    #타이머 집어넣기
    #경과시간 계산
    elapsed_timd = (pygame.time.get_ticks() - start_ticks) / 1000
    #경과시간 ms를 10000으로 나누어 초(s) 단위로 바꿈

    timer = game_font.render(str(int(total_time- elapsed_timd)), True, (255, 255, 255))
     # 출력할 글자, True, 글자색상
    screen.blit(timer, (10 ,10))

    #만약 시간이 0 이하이면 게임 종료
    if total_time - elapsed_timd <= 0:
        print("time out")
        running = False
